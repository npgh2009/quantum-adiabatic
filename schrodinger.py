...
"""
Edited from original by: npgh2009
"""
import numpy as np
...
class Schrodinger(object):
    ...
    """
    def __init__(self, x, psi_x0, V_x, k0=None, hbar=1, m=0.5, t0=0.0):
        """
        Parameters
        ----------
        x : array_like, float
        ...
        V_x : array_like, float
            Length-N array giving the potential at each x, at initial time
        k0 : float
        ...
        m : float
            Particle mass (default = 0.5, so that coefficients in SEq vanish)
        t0 : float
